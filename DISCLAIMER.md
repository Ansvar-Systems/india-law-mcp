...
- **Professional Rules**: Bar Council of India members must comply with applicable professional conduct rules when using AI tools
...
1. Checking the official source (India Code (indiacode.nic.in), e-Gazette)
...
This Tool aggregates data from official India legal databases. However:
...
- SCC Online, Manupatra, Indian Kanoon
...
- India law changes continuously through new statutes, amendments, and court decisions
...
2. **Official Verification**: Cross-check ALL results with official sources (India Code (indiacode.nic.in), e-Gazette)
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/India-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/India-law-mcp/issues
