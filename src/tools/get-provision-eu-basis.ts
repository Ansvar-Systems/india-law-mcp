/**
 * get_provision_eu_basis — Get EU/international legal basis for a specific Indian provision.
 */
    ...
    results: {
      ...
      eu_references: rows.map(r => {
        const ref: ProvisionEUReference = {
          id: r.id, type: r.type,
          reference_type: r.reference_type as ProvisionEUReference['reference_type'],
