...
const GITHUB_REPO = 'Ansvar-Systems/india-law-mcp';
...
async function initializeDatabase(): Promise<void> {
  ...
  const envDb = process.env.INDIA_LAW_DB_PATH;
  ...
  const downloadUrl = process.env.INDIA_LAW_DB_URL ?? DEFAULT_RELEASE_URL;
